...
var createNewTaskElement = function(taskString) {
    ...
    label.classList.add("label", "todo__label");
    ...
    editButton.classList.add("todo__edit", "button", "button_edit");

    deleteButton.classList.add("button", "button_remove");
...
//select ListItems children
    ...
    var deleteButton = taskListItem.querySelector(".button_remove");
